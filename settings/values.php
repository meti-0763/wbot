...
$mainValues = [
    ...
    'customer_custome_plan_name'=>'اسم کانفیگ رو وارد کن ( حروف انگلیسی و عدد باهم وارد کنید )',
...
مدت زمان سرویس: DAYS روز',
    ...
    'incorrect_config_name'=>"فقط حروف کوچیک و عدد بزن ",
